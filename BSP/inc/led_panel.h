...
extern "C"
{
	...
	{
		LedPanelId0 = 0u,
		LedPanelIdCount = BSP_TM3100_LED_COUNT,
	} en_led_panel_id_t;
	...
	typedef struct stc_led_panel_ops
	{
		...
		en_result_t (*set)(uint16_t led_id, boolean_t on);
		en_result_t (*set_chip_channel)(uint8_t chip, uint8_t channel, boolean_t on);
